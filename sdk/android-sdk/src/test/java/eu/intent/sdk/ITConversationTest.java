...
public class ITConversationTest {
    ...
    public void jsonToConversation() {
        String json = TestUtils.INSTANCE.getResourceAsString("conversation.json");
        ITConversation conversation = TestUtils.INSTANCE.getGson().fromJson(json, ITConversation.class);
